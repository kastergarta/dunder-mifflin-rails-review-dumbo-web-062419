...
# d1 = Dog.create(name: "den", breed: "blue", age: 1)
# d2 = Dog.create(name: "anna", breed: "gold", age: 1)
# d3 = Dog.create(name: "max", breed: "silver", age: 1)
#
# e1 = Employee.create(first_name: "Jim", last_name: "Halpert", alias: "Big Tuna", title: "Regional Co-Manager", office: "Scranton", img_url: "https://s-i.huffpost.com/gen/2028878/images/n-UPROXX-628x314.jpg", :dog_id 1)
# e2 = Employee.create(first_name: "Jimm", last_name: "Halpert", alias: "Big Tuna", title: "Regional Co-Manager", office: "Scranton", img_url: "https://s-i.huffpost.com/gen/2028878/images/n-UPROXX-628x314.jpg", :dog_id 1)
# e3 = Employee.create(first_name: "Jimn", last_name: "Halpert", alias: "Big Tuna", title: "Regional Co-Manager", office: "Scranton", img_url: "https://s-i.huffpost.com/gen/2028878/images/n-UPROXX-628x314.jpg", :dog_id 3)
